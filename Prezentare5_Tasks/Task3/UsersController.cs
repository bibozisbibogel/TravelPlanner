...
public class UsersController : ControllerBase
{
    ...
    public UsersController(IUserService service, UserManager<ApplicationUser> userManager,
    ...
    {
        var user = await _service.LoginAsync(request.Email, request.Password, request.RememberMe);
        if (user == null)
